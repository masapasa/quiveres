...
export const metadata = {
  title: "Nubri - Get a Second Brain with Generative AI",
  description:
    "Nubri is a datalake in the cloud, designed to easily store and retrieve unstructured information and manage data.",
};
